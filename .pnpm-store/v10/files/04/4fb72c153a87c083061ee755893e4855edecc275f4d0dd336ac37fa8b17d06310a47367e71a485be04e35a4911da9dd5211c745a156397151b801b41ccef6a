    ...
    Tooltip.prototype.renderTooltipMarkers = function (items, marker) {
        ...
        try {
            for (var items_3 = tslib_1.__values(items), items_3_1 = items_3.next(); !items_3_1.done; items_3_1 = items_3.next()) {
                ...
                var attrs = tslib_1.__assign(tslib_1.__assign({ fill: item.color, symbol: 'circle', shadowColor: item.color }, ((0, util_1.isFunction)(marker) ? tslib_1.__assign(tslib_1.__assign({}, markerDefaultCfg), marker(item)) : marker)), { x: x, y: y });
