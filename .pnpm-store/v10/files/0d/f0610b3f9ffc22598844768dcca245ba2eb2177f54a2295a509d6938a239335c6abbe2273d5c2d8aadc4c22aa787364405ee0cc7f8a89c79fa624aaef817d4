...
function getDistanceMatrices(areas, sets, setids) {
    ...
    var distances = (0, fmin_1.zerosM)(sets.length, sets.length), constraints = (0, fmin_1.zerosM)(sets.length, sets.length);
    ...
    for (var i = 1; i < mostOverlapped.length; ++i) {
        ...
        for (var j = 0; j < overlap.length; ++j) {
            ...
            for (var k = j + 1; k < overlap.length; ++k) {
                ...
                var extraPoints = (0, circleintersection_1.circleCircleIntersection)({ x: p1.x, y: p1.y, radius: d1 }, { x: p2.x, y: p2.y, radius: d2 });
