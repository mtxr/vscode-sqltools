...
- **Extension**
  ...
  - Use gethue as sql parser for autocomplete context. [#755](https://github.com/mtxr/vscode-sqltools/issues/777).
  - Truncate query text not to explode result tab. [#774](https://github.com/mtxr/vscode-sqltools/issues/774).
