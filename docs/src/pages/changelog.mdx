...
* **Enhancements**
  * Use driver icon on connection explorer. Commit [#c349b6d](https://github.com/mtxr/vscode-sqltools/commit/c349b6d8a89b67e66db0eecb4869f268c419cdc4)
  * PostgreSQL: Add support for reading certificates when using SSL. [#374](https://github.com/mtxr/vscode-sqltools/issues/374)
