...
Each statement in a block can optionally be preceded by a comment line of the form `-- @label Some Text` to make the result tab label become `Some Text` instead of the first 16 characters of the statement.
