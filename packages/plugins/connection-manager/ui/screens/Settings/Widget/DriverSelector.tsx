...
const DriverSelector = ({ onSelect, selected, drivers = [] }) => (
  <>
    ...
    <Container maxWidth='sm'>
      ...
      {drivers.length === 0 && <Grid style={{ textAlign: 'center', padding: '5rem', height: '10rem', justifyContent: 'space-evenly', flexDirection: 'column', display: 'flex' }}>
