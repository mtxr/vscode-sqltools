...
it('Format simple update query', () => {
  expect(
    ...
    `UPDATE user
SET password_requested_at = NULL,
...
it('Format vscode query snippet', () => {
  expect(
    format(
      "INSERT INTO  access_token (created, id, scopes, ttl, userid) VALUES  ('${1:timestamp with time zone}', '${2:text}', '${3:text}', '${4:integer}', '${5:integer}');"
    )
  ).toEqual(
